  ...
  "en-US": {
    common: {
      labels: {
        ...
        lexioContext: "Tupa Context",
        lexioCapture: "Tupa Capture",
        word: "Word",
        phrase: "Phrase",
      },
      navigation: {
    ...
    wordBank: {
      ...
      empty: {
        accountBadge: "Tupa Account",
        accountTitle: "Sign in to open your Word Bank",
        accountDescription: "Your saved words only appear after you sign in with the same Tupa account used by the extension.",
        searchBadge: "Search",
    ...
    pricing: {
      badge: "Hosted Plans",
      title: "One plan keeps Tupa clear, focused, and ready across surfaces.",
    ...
    checkoutSuccess: {
      ...
      description: "Tupa received the checkout result. If you installed the browser extension, open the authorization page once so the extension can refresh its access state.",
    ...
    extensionSync: {
      ...
      sendingSession: "Sending your current Tupa session to the extension.",
      ...
      successDescription: "Tupa has sent your current sign-in session to the extension. You can return to the extension now.",
      ...
      authorizeDescription: "Allow the Tupa browser extension to use your current sign-in session and sync words into your Tupa account.",
      requestedAccess: "Requested Access",
      permissions: {
        wordBankTitle: "Save words to your Word Bank",
        wordBankBody: "The extension can add saved words and definitions to the same Tupa account you are using here.",
        ...
        sessionBody: "The extension receives a fresh Tupa session token so it can act on your behalf after you approve.",
      },
      secureNote: "Secure authorization via Tupa",
    },
    signIn: {
      title: "Sign in once. Return to your library, practice, and extension flow.",
      description: "Use your Tupa account to keep saved words, practice progress, and extension authorization in one place.",
    },
    practice: {
      loadingBadge: "Practice",
      loadingTitle: "Loading",
      loadingDescription: "Fetching your saved words and context sentences from Tupa.",
      signInBadge: "Tupa Account",
      signInTitle: "Sign in to start practice",
      signInDescription: "Your typing session uses the same remote Word Bank data that the extension syncs to Tupa.",
  ...
  "zh-CN": {
    common: {
      labels: {
        ...
        lexioContext: "Tupa 语境",
        lexioCapture: "Tupa 收藏",
        word: "单词",
        phrase: "词组",
      },
      navigation: {
    ...
    wordBank: {
      ...
      empty: {
        accountBadge: "Tupa 账号",
        accountTitle: "登录后打开你的单词本",
        accountDescription: "只有登录和扩展里相同的 Tupa 账号后，这里的收藏词才会显示出来。",
        searchBadge: "搜索",
        searchTitle: "没有匹配的单词",
    ...
    pricing: {
      badge: "托管方案",
      title: "一个方案就够，让 Tupa 在不同页面里都保持清爽、稳定。",
    ...
    checkoutSuccess: {
      badge: "支付完成",
      title: "你的方案已经更新。",
      description: "Tupa 已经收到支付结果。如果你装了浏览器扩展，再打开一次授权页，让扩展刷新访问状态。",
    ...
    extensionSync: {
      ...
      sendingSession: "正在把你当前的 Tupa 会话发送给扩展。",
      tokenMissing: "Clerk 没有返回会话 token。",
      syncFailed: "扩展同步失败",
      connected: "扩展已连接。",
      connectedToast: "扩展已连接。",
      successTitle: "扩展已连接",
      successDescription: "Tupa 已经把你当前的登录会话发送给扩展。现在可以回到扩展继续使用了。",
      successNote: "如果这个标签页还开着，手动关掉它，然后回到扩展弹窗继续。",
      authorizeTitle: "授权扩展",
      authorizeDescription: "允许 Tupa 浏览器扩展使用你当前的登录会话，并把收藏单词同步到你的 Tupa 账号。",
      requestedAccess: "申请的权限",
      permissions: {
        wordBankTitle: "把单词保存到你的单词本",
        wordBankBody: "扩展可以把收藏单词和释义写进你当前使用的同一个 Tupa 账号。",
        profileTitle: "基础账号资料",
        profileBody: "扩展会读取你的显示名、邮箱和头像，用来识别当前账号。",
        sessionTitle: "当前登录会话",
        sessionBody: "扩展会拿到一枚新的 Tupa 会话 token，在你确认后代表你执行同步操作。",
      },
      secureNote: "通过 Tupa 进行安全授权",
    },
    signIn: {
      title: "登录一次，单词本、练习和扩展授权就能接上。",
      description: "用你的 Tupa 账号统一保存收藏单词、练习进度和扩展授权状态。",
    },
    practice: {
      loadingBadge: "练习",
      loadingTitle: "正在加载",
      loadingDescription: "正在从 Tupa 拉取你收藏的单词和语境句子。",
      signInBadge: "Tupa 账号",
      signInTitle: "登录后开始练习",
      signInDescription: "这里的打字练习会直接使用扩展同步到 Tupa 的远程单词本数据。",
      errorBadge: "练习出错",
      errorTitle: "练习队列加载失败",
  ...
  "ja-JP": {
    common: {
      labels: {
        ...
        lexioContext: "Tupa コンテキスト",
        lexioCapture: "Tupa 保存",
        word: "単語",
        phrase: "フレーズ",
      },
      navigation: {
    ...
    wordBank: {
      ...
      empty: {
        accountBadge: "Tupa アカウント",
        accountTitle: "サインインして単語帳を開く",
        accountDescription: "拡張で使っているのと同じ Tupa アカウントでサインインすると、保存した単語がここに表示されます。",
        searchBadge: "検索",
    ...
    pricing: {
      badge: "ホストプラン",
      title: "Tupa をどの画面でも静かに、すぐ使える状態で保つための一つのプランです。",
    ...
    checkoutSuccess: {
      badge: "決済完了",
      title: "プランを更新しました。",
      description: "Tupa が決済結果を受け取りました。拡張を入れている場合は、一度認可ページを開いてアクセス状態を更新してください。",
    ...
    extensionSync: {
      ...
      sendingSession: "現在の Tupa セッションを拡張へ送信しています。",
      tokenMissing: "Clerk からセッショントークンが返りませんでした。",
      syncFailed: "拡張の同期に失敗しました",
      connected: "拡張を接続しました。",
      connectedToast: "拡張を接続しました。",
      successTitle: "拡張を接続しました",
      successDescription: "Tupa は現在のサインイン状態を拡張へ送りました。拡張に戻って続けられます。",
      successNote: "このタブが残っている場合は手動で閉じ、拡張ポップアップに戻ってください。",
      authorizeTitle: "拡張を認可",
      authorizeDescription: "Tupa ブラウザ拡張が現在のサインイン状態を使い、保存単語を Tupa アカウントに同期できるようにします。",
      requestedAccess: "要求されるアクセス",
      permissions: {
        wordBankTitle: "単語帳への保存",
        wordBankBody: "拡張は、ここで使っているのと同じ Tupa アカウントに単語と定義を保存できます。",
        profileTitle: "基本プロフィール",
        profileBody: "拡張は、表示名、メールアドレス、アバターをアカウント識別のために受け取ります。",
        sessionTitle: "現在のサインイン状態",
        sessionBody: "認可後、拡張は新しい Tupa セッショントークンを受け取り、あなたの代わりに同期できます。",
      },
      secureNote: "Tupa による安全な認可",
    },
    signIn: {
      title: "一度サインインすれば、単語帳、練習、拡張認可までつながります。",
      description: "Tupa アカウントで、保存単語、練習の進み具合、拡張の認可状態を一つにまとめます。",
    },
    practice: {
      loadingBadge: "練習",
      loadingTitle: "読み込み中",
      loadingDescription: "Tupa から保存単語と文脈文を取得しています。",
      signInBadge: "Tupa アカウント",
      signInTitle: "サインインして練習を始める",
      signInDescription: "このタイピング練習は、拡張から Tupa に同期されたリモート単語帳データを使います。",
      errorBadge: "練習エラー",
