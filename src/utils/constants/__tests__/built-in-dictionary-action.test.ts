...
describe("built-in dictionary action", () => {
  it("puts stream-critical meaning fields before enrichment fields", () => {
  ...
  it("keeps the lemma fields stable and only localizes the definition", () => {
    ...
    expect(action.systemPrompt).toContain("Produce definition and contextSentenceTranslation before slower enrichment fields")
