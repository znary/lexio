...
const VOCABULARY_HIGHLIGHT_BOUNDARY_LIMITER_SOURCE = `!"#$%&'()*+,-./:;<=>?@[\\]^_\`{|}~`
export const VOCABULARY_HIGHLIGHT_BOUNDARY_LIMITERS = Array.from(VOCABULARY_HIGHLIGHT_BOUNDARY_LIMITER_SOURCE)
